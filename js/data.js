...
/* ---------- equipment taxonomy (Phase 3 foundation) ----------
   A comprehensive, categorized list of brewing equipment — not just what's in
   one kitchen. `id` is the canonical value stored on recipes (top-level
   `method` and each `methods[].id`) and in a user's owned-equipment set; `hint`
   is a short "what it looks like" line for the onboarding picker. Grouped by
   category in display order, so the onboarding/equipment UI can render
   sections straight off this array without re-sorting. */
const EQUIPMENT_TAXONOMY = [
  { id:'instant',        label:'Instant coffee',                  category:'No equipment',          hint:'A jar of instant granules — no brewing gear at all.' },
  { id:'coffee_bags',    label:'Coffee bags',                     category:'No equipment',          hint:'Like a tea bag, steeped straight in the cup.' },

  { id:'french_press',   label:'French press',                    category:'Steeping / Immersion',  hint:'A plunger pot — coarse grounds steeped, then pressed.' },
  { id:'cold_brew',      label:'Cold brew (immersion)',            category:'Steeping / Immersion',  hint:'Grounds steeped in cold water for hours, then strained.' },
  { id:'siphon',         label:'Siphon / vacuum pot',              category:'Steeping / Immersion',  hint:'Two chambers — vapor pressure pulls water up through the coffee.' },
  { id:'cowboy',         label:'Cowboy coffee (boiled)',           category:'Steeping / Immersion',  hint:'Grounds (or husks) boiled directly in water, no filter.' },

  { id:'v60',            label:'V60 / pour-over cone',             category:'Pour-over (Manual)',    hint:'A ribbed cone dripper with a paper filter, poured by hand.' },
  { id:'chemex',         label:'Chemex',                           category:'Pour-over (Manual)',    hint:'Hourglass glass carafe with a thick paper filter.' },
  { id:'kalita',         label:'Kalita Wave',                      category:'Pour-over (Manual)',    hint:'A flat-bottomed dripper for an even, consistent pour.' },
  { id:'pour_over',      label:'Pour-over cone (generic)',         category:'Pour-over (Manual)',    hint:'Any basic cone dripper — not brand-specific.' },
  { id:'hybrid_dripper', label:'Hybrid / "Switch" dripper',        category:'Pour-over (Manual)',    hint:'Steeps like immersion, then drains like pour-over.' },

  { id:'drip_machine',   label:'Drip coffee machine',              category:'Pour-over (Automatic)', hint:'An electric machine that drips hot water over grounds.' },
  { id:'pod_machine',    label:'Pod machine',                      category:'Pour-over (Automatic)', hint:'Nespresso/Keurig-style single-serve capsule machine.' },

  { id:'espresso',       label:'Espresso machine',                 category:'Pressure',              hint:'Forces hot water through fine grounds under pressure.' },
  { id:'moka',           label:'Moka pot (stovetop)',              category:'Pressure',              hint:'A stovetop pot that pushes coffee up through steam pressure.' },
  { id:'aeropress',      label:'AeroPress',                        category:'Pressure',              hint:'A syringe-like plunger — steep, then press through a filter.' },
  { id:'percolator',     label:'Percolator',                       category:'Pressure',              hint:'Boiling water cycles up through the grounds repeatedly.' },

  { id:'cezve',          label:'Cezve / ibrik (Turkish, Greek)',   category:'Traditional',            hint:'A small long-handled pot for unfiltered, finely-ground coffee.' },
  { id:'phin',           label:'Vietnamese phin',                  category:'Traditional',            hint:'A small metal drip filter that sits right on the cup.' },
  { id:'south_indian',   label:'South Indian filter',              category:'Traditional',            hint:'A two-chamber steel tumbler-and-davara filter.' },
  { id:'dallah',         label:'Dallah (Arabic coffee)',           category:'Traditional',            hint:'A long-spouted pot for lightly-spiced Arabic coffee.' },
  { id:'jebena',         label:'Jebena (Ethiopian)',               category:'Traditional',            hint:'A clay pot used in the Ethiopian coffee ceremony.' },
  { id:'kopi_tubruk',    label:'Kopi tubruk (boiled, Indonesian)', category:'Traditional',            hint:'Coarse grounds boiled directly, settled before drinking.' },

  { id:'cold_drip',      label:'Cold drip tower',                  category:'Cold specialty',        hint:'A Kyoto-style tower drips ice water slowly over grounds.' },
  { id:'nitro',          label:'Nitro (kegged cold brew)',         category:'Cold specialty',        hint:'Cold brew charged with nitrogen for a creamy pour.' },
...
const SEED = [
{
  ...
  method:"moka", origin:"Fusion", ratio:"1:2:1", ratioLabel:"mango : milk : coffee", strength:3,
...
},
{
  ...
  method:"moka", origin:"Vietnam", ratio:"1:2", ratioLabel:"coffee : coconut blend", strength:4,
...
},
{
  ...
  method:"moka", origin:"Vietnam", ratio:"1:2", ratioLabel:"coffee : egg foam", strength:4,
...
},
{
  ...
  method:"moka", origin:"Vietnam", ratio:"1:2", ratioLabel:"condensed milk : coffee", strength:4,
...
},
{
  ...
  method:"moka", origin:"Spain", ratio:"1:1", ratioLabel:"condensed milk : coffee", strength:4,
...
},
{
  ...
  method:"moka", origin:"Indonesia", ratio:"1:2", ratioLabel:"condensed milk : coffee", strength:4,
...
},
{
  ...
  method:"moka", origin:"Thailand", ratio:"1:2", ratioLabel:"milk : coffee", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-12'),
...
},
{
  ...
  method:"moka", origin:"Italy", ratio:"2:1", ratioLabel:"coffee : sugar", strength:4,
...
},
{
  ...
  method:"moka", origin:"Portugal", ratio:"4:1", ratioLabel:"coffee : lemon juice", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-14'),
...
},
{
  ...
  method:"moka", origin:"Mexico", ratio:"2:1", ratioLabel:"coffee : jaggery", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-14'),
...
},
{
  ...
  method:"moka", origin:"India", ratio:"1:3", ratioLabel:"decoction : milk", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-14'),
...
},
{
  ...
  method:"moka", origin:"Cuba", ratio:"1:1", ratioLabel:"coffee : milk", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-14'),
...
},
{
  ...
  method:"moka", origin:"Morocco", ratio:"½ tsp", ratioLabel:"spice blend per cup", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-14'),
...
},
{
  ...
  method:"moka", origin:"Hong Kong", ratio:"3:7", ratioLabel:"coffee : milk tea", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-14'),
...
},
{
  ...
  method:"moka", origin:"Italy", ratio:"1:1", ratioLabel:"coffee : ice cream", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-14'),
...
},
{
  ...
  method:"moka", origin:"Austria", ratio:"1:1", ratioLabel:"coffee : cream cap", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-14'),
...
},
{
  ...
  method:"moka", origin:"Modern café", ratio:"2–3 tbsp", ratioLabel:"dolce syrup per glass", strength:3,
...
},
{
  ...
  method:"moka", origin:"Yemen / worldwide", ratio:"1:1", ratioLabel:"coffee : chocolate", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Malaysia", ratio:"1:2", ratioLabel:"coffee : milk blend", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Brazil", ratio:"strong & sweet", ratioLabel:"small black cup", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Spain", ratio:"1:1", ratioLabel:"coffee : spirit", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Ethiopia", ratio:"strong & black", ratioLabel:"no milk", strength:5,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Senegal", ratio:"½ tsp", ratioLabel:"spice per cup", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  methods:[
    {
      id:"cowboy", label:"Stovetop", recommended:true,
...
},
{
  ...
  method:"blender", origin:"Fusion", ratio:"blend", ratioLabel:"banana + milk + coffee", strength:2,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"blender", origin:"India", ratio:"blend", ratioLabel:"milk + coffee + ice cream", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"blender", origin:"India", ratio:"blend", ratioLabel:"chikoo + milk + coffee", strength:2,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Fusion", ratio:"2:1", ratioLabel:"juice : coffee", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Fusion", ratio:"fizzy", ratioLabel:"juice + coffee + soda", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Japan", ratio:"set", ratioLabel:"coffee jelly + milk", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Korea / Japan", ratio:"2:1", ratioLabel:"milk : coffee", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Taiwan", ratio:"build", ratioLabel:"syrup + milk + coffee", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Taiwan", ratio:"cap", ratioLabel:"coffee + cheese foam", strength:3,
  tried:false, rating:0, createdAt:D('2026-06-20'),
...
},
{
  ...
  method:"moka", origin:"Japan", ratio:"strong on ice", ratioLabel:"brew onto ice", strength:4,
  tried:false, rating:0, createdAt:D('2026-06-20'),
